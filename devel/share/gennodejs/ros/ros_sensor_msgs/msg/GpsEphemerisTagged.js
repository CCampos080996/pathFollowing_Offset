...
class GpsEphemerisTagged {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('ephemeris')) {
        ...
        this.ephemeris = new GpsEphemeris();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GpsEphemeris.serialize(obj.ephemeris, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GpsEphemerisTagged(null);
    ...
    data.ephemeris = GpsEphemeris.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'ros_sensor_msgs/GpsEphemerisTagged';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '99c9da17e55780793d8933f31abf1cc8';
  }

  static messageDefinition() {
    // Returns full string definition for message
    return `
    ## Gps Ephemeris subframes for one satellite with header
  ...
  static Resolve(msg) {
    ...
    const resolved = new GpsEphemerisTagged(null);
    ...
    if (msg.ephemeris !== undefined) {
      resolved.ephemeris = GpsEphemeris.Resolve(msg.ephemeris)
    }
    else {
      resolved.ephemeris = new GpsEphemeris()
    }
...
module.exports = GpsEphemerisTagged;
