...
class SvRaeTagged {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('svRae')) {
        this.svRae = initObj.svRae
      }
      else {
        this.svRae = new SvRae();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [svRae]
    bufferOffset = SvRae.serialize(obj.svRae, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SvRaeTagged(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [tags]
    data.tags = Tags.deserialize(buffer, bufferOffset);
    // Deserialize message field [svRae]
    data.svRae = SvRae.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static messageDefinition() {
    ...
    return `
    # SvRae information with tags and header
  ...
  static Resolve(msg) {
    ...
    const resolved = new SvRaeTagged(null);
    ...
    if (msg.svRae !== undefined) {
      resolved.svRae = SvRae.Resolve(msg.svRae)
    }
    else {
      resolved.svRae = new SvRae()
    }
