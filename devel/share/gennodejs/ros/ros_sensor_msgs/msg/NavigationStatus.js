...
class NavigationStatus {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.uint16(obj.navigation_status, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.navigation_status = _deserializer.uint16(buffer, bufferOffset);
    return data;
  }
