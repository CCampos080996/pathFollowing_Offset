...
class UtcIonosphereTagged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new UtcIonosphereTagged(null);
  ...
  static datatype() {
    ...
    return 'ros_sensor_msgs/UtcIonosphereTagged';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'f7b92f8465167be7ab2c61e6df237b34';
  }

  static messageDefinition() {
    // Returns full string definition for message
    return `
    ## Subframe of UTC and Ionospheric Parameters with header
  ...
  static Resolve(msg) {
    ...
    const resolved = new UtcIonosphereTagged(null);
...
module.exports = UtcIonosphereTagged;
