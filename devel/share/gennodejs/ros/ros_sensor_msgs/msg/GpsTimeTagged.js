...
class GpsTimeTagged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GpsTimeTagged(null);
  ...
  static datatype() {
    ...
    return 'ros_sensor_msgs/GpsTimeTagged';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '9abe546f68bb329d747595a14569330b';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GpsTimeTagged(null);
