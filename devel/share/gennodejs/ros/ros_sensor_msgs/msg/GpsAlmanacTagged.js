...
class GpsAlmanacTagged {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.header = null;
      this.tags = null;
      this.gpsAlmanac = null;
    }
    else {
      ...
      if (initObj.hasOwnProperty('gpsAlmanac')) {
        this.gpsAlmanac = initObj.gpsAlmanac
      }
      else {
        this.gpsAlmanac = new GpsAlmanac();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [gpsAlmanac]
    bufferOffset = GpsAlmanac.serialize(obj.gpsAlmanac, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GpsAlmanacTagged(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [tags]
    data.tags = Tags.deserialize(buffer, bufferOffset);
    // Deserialize message field [gpsAlmanac]
    data.gpsAlmanac = GpsAlmanac.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'ros_sensor_msgs/GpsAlmanacTagged';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '36185a7fc3add6c8144cda3e4f32907b';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GpsAlmanacTagged(null);
    ...
    if (msg.gpsAlmanac !== undefined) {
      resolved.gpsAlmanac = GpsAlmanac.Resolve(msg.gpsAlmanac)
    }
    else {
      resolved.gpsAlmanac = new GpsAlmanac()
    }
...
module.exports = GpsAlmanacTagged;
