...
class RfRangesStamped {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    obj.ranges.forEach((val) => {
      bufferOffset = RfRange.serialize(val, buffer, bufferOffset);
    });
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RfRangesStamped(null);
    ...
    for (let i = 0; i < len; ++i) {
      data.ranges[i] = RfRange.deserialize(buffer, bufferOffset)
    }
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 48 * object.ranges.length;
    return length + 4;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RfRangesStamped(null);
    ...
    if (msg.ranges !== undefined) {
      ...
      for (let i = 0; i < resolved.ranges.length; ++i) {
        resolved.ranges[i] = RfRange.Resolve(msg.ranges[i]);
      }
    }
    else {
      resolved.ranges = []
...
module.exports = RfRangesStamped;
