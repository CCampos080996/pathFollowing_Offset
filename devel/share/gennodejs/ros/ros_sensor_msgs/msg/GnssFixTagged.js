...
class GnssFixTagged {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('gnssFix')) {
        this.gnssFix = initObj.gnssFix
      }
      else {
        this.gnssFix = new GnssFix();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [gnssFix]
    bufferOffset = GnssFix.serialize(obj.gnssFix, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GnssFixTagged(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [tags]
    data.tags = Tags.deserialize(buffer, bufferOffset);
    // Deserialize message field [gnssFix]
    data.gnssFix = GnssFix.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GnssFixTagged(null);
    ...
    if (msg.gnssFix !== undefined) {
      resolved.gnssFix = GnssFix.Resolve(msg.gnssFix)
    }
    else {
      resolved.gnssFix = new GnssFix()
    }
