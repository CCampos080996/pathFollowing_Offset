...
class EnuVelocityTagged {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EnuVelocityTagged(null);
  ...
  static datatype() {
    ...
    return 'ros_sensor_msgs/EnuVelocityTagged';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'dbc839fae8ba36a3a3721a35d2ea7099';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EnuVelocityTagged(null);
...
module.exports = EnuVelocityTagged;
