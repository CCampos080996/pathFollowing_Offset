...
(cl:defmethod cl:initialize-instance :after ((m <SetInt32-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetInt32-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_sensor_msgs-srv:<SetInt32-request> is deprecated: use ros_sensor_msgs-srv:SetInt32-request instead.")))

(cl:ensure-generic-function 'i32-val :lambda-list '(m))
(cl:defmethod i32-val ((m <SetInt32-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_sensor_msgs-srv:i32-val is deprecated.  Use ros_sensor_msgs-srv:i32 instead.")
  (i32 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetInt32-request>)))
  ...
  "ros_sensor_msgs/SetInt32Request")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetInt32-request)))
  "Returns string type for a service object of type 'SetInt32-request"
  "ros_sensor_msgs/SetInt32Request")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetInt32-request>)))
  ...
  "04d7cbd5177c76f7add321244a139b5c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetInt32-request)))
  "Returns md5sum for a message object of type 'SetInt32-request"
  "04d7cbd5177c76f7add321244a139b5c")
...
(cl:defmethod cl:initialize-instance :after ((m <SetInt32-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetInt32-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_sensor_msgs-srv:<SetInt32-response> is deprecated: use ros_sensor_msgs-srv:SetInt32-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetInt32-response>)))
  ...
  "ros_sensor_msgs/SetInt32Response")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetInt32-response)))
  "Returns string type for a service object of type 'SetInt32-response"
  "ros_sensor_msgs/SetInt32Response")
