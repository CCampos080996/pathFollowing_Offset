...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat64-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat64-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_sensor_msgs-srv:<SetFloat64-request> is deprecated: use ros_sensor_msgs-srv:SetFloat64-request instead.")))

(cl:ensure-generic-function 'f64-val :lambda-list '(m))
(cl:defmethod f64-val ((m <SetFloat64-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ros_sensor_msgs-srv:f64-val is deprecated.  Use ros_sensor_msgs-srv:f64 instead.")
  (f64 m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFloat64-request>)))
  ...
  "ros_sensor_msgs/SetFloat64Request")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFloat64-request)))
  "Returns string type for a service object of type 'SetFloat64-request"
  "ros_sensor_msgs/SetFloat64Request")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<SetFloat64-request>)))
  ...
  "998706f213761460dbdc37d3d50cd39b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'SetFloat64-request)))
  "Returns md5sum for a message object of type 'SetFloat64-request"
  "998706f213761460dbdc37d3d50cd39b")
...
(cl:defmethod cl:initialize-instance :after ((m <SetFloat64-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFloat64-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_sensor_msgs-srv:<SetFloat64-response> is deprecated: use ros_sensor_msgs-srv:SetFloat64-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFloat64-response>)))
  ...
  "ros_sensor_msgs/SetFloat64Response")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFloat64-response)))
  "Returns string type for a service object of type 'SetFloat64-response"
  "ros_sensor_msgs/SetFloat64Response")
