...
"""autogenerated by genpy from ros_sensor_msgs/ErrorFilterOutput.msg. Do not edit."""
import sys
...
class ErrorFilterOutput(genpy.Message):
  _md5sum = "67e8d7bcf6c0dfb06e37f3b17fd4edc6"
  _type = "ros_sensor_msgs/ErrorFilterOutput"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """## 17-state error navigation filter output
...
float64 clock_drift   # Receiver clock drift [sec/sec]"""
  __slots__ = ['header','tags','orientationErr','velocityErr','positionErr','accelBias','gyroBias','clock']
  _slot_types = ['std_msgs/Header','ros_sensor_msgs/Tags','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','ros_sensor_msgs/ClockParameters']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,tags,orientationErr,velocityErr,positionErr,accelBias,gyroBias,clock
    ...
    """
    if args or kwds:
      super(ErrorFilterOutput, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.tags is None:
        self.tags = ros_sensor_msgs.msg.Tags()
      if self.orientationErr is None:
        self.orientationErr = geometry_msgs.msg.Vector3()
      if self.velocityErr is None:
        self.velocityErr = geometry_msgs.msg.Vector3()
      if self.positionErr is None:
        self.positionErr = geometry_msgs.msg.Vector3()
      ...
      if self.clock is None:
        self.clock = ros_sensor_msgs.msg.ClockParameters()
    else:
      self.header = std_msgs.msg.Header()
      self.tags = ros_sensor_msgs.msg.Tags()
      self.orientationErr = geometry_msgs.msg.Vector3()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3B17d().pack(_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.orientationErr.x, _x.orientationErr.y, _x.orientationErr.z, _x.velocityErr.x, _x.velocityErr.y, _x.velocityErr.z, _x.positionErr.x, _x.positionErr.y, _x.positionErr.z, _x.accelBias.x, _x.accelBias.y, _x.accelBias.z, _x.gyroBias.x, _x.gyroBias.y, _x.gyroBias.z, _x.clock.clock_bias, _x.clock.clock_drift))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.orientationErr.x, _x.orientationErr.y, _x.orientationErr.z, _x.velocityErr.x, _x.velocityErr.y, _x.velocityErr.z, _x.positionErr.x, _x.positionErr.y, _x.positionErr.z, _x.accelBias.x, _x.accelBias.y, _x.accelBias.z, _x.gyroBias.x, _x.gyroBias.y, _x.gyroBias.z, _x.clock.clock_bias, _x.clock.clock_drift,) = _get_struct_3B17d().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_3B17d = None
def _get_struct_3B17d():
    global _struct_3B17d
    if _struct_3B17d is None:
        _struct_3B17d = struct.Struct("<3B17d")
    return _struct_3B17d
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
