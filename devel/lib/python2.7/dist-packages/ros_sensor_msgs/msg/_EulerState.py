...
"""autogenerated by genpy from ros_sensor_msgs/EulerState.msg. Do not edit."""
import sys
...
class EulerState(genpy.Message):
  _md5sum = "4651f6a5328b6bbe00f184a799df153d"
  _type = "ros_sensor_msgs/EulerState"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """## XYZ velocity and associated covariance
...
float64[9] covariance"""
  __slots__ = ['roll','pitch','yaw','covariance']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EulerState, self).__init__(*args, **kwds)
