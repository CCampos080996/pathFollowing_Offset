...
"""autogenerated by genpy from ros_sensor_msgs/GpsEphemerisTagged.msg. Do not edit."""
import sys
...
class GpsEphemerisTagged(genpy.Message):
  _md5sum = "99c9da17e55780793d8933f31abf1cc8"
  _type = "ros_sensor_msgs/GpsEphemerisTagged"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """## Gps Ephemeris subframes for one satellite with header
...
uint8[30]   subframe2
uint8[30]   subframe3"""
  __slots__ = ['header','tags','ephemeris']
  _slot_types = ['std_msgs/Header','ros_sensor_msgs/Tags','ros_sensor_msgs/GpsEphemeris']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GpsEphemerisTagged, self).__init__(*args, **kwds)
      ...
      if self.ephemeris is None:
        self.ephemeris = ros_sensor_msgs.msg.GpsEphemeris()
    else:
      self.header = std_msgs.msg.Header()
      self.tags = ros_sensor_msgs.msg.Tags()
      self.ephemeris = ros_sensor_msgs.msg.GpsEphemeris()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3BH().pack(_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.ephemeris.prn))
      _x = self.ephemeris.subframe1
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(_get_struct_30B().pack(*_x))
      else:
        buff.write(_get_struct_30s().pack(_x))
      _x = self.ephemeris.subframe2
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(_get_struct_30B().pack(*_x))
      else:
        buff.write(_get_struct_30s().pack(_x))
      _x = self.ephemeris.subframe3
      # - if encoded as a list instead, serialize as bytes instead of string
      if type(_x) in [list, tuple]:
        buff.write(_get_struct_30B().pack(*_x))
      else:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.ephemeris.prn,) = _get_struct_3BH().unpack(str[start:end])
      self.tags.dataValid = bool(self.tags.dataValid)
      start = end
      end += 30
      self.ephemeris.subframe1 = str[start:end]
      start = end
      end += 30
      self.ephemeris.subframe2 = str[start:end]
      start = end
      end += 30
      self.ephemeris.subframe3 = str[start:end]
      return self
