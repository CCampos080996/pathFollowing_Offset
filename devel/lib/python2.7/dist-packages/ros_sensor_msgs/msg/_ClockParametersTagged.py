...
"""autogenerated by genpy from ros_sensor_msgs/ClockParametersTagged.msg. Do not edit."""
import sys
...
class ClockParametersTagged(genpy.Message):
  _md5sum = "00a77dec09177048ccbc1e9ea3bc5fb2"
  _type = "ros_sensor_msgs/ClockParametersTagged"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """## Recevier clock parameters with header
...
float64 clock_drift   # Receiver clock drift [sec/sec]"""
  __slots__ = ['header','tags','clock']
  _slot_types = ['std_msgs/Header','ros_sensor_msgs/Tags','ros_sensor_msgs/ClockParameters']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ClockParametersTagged, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3B2d().pack(_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.clock.clock_bias, _x.clock.clock_drift))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.clock.clock_bias, _x.clock.clock_drift,) = _get_struct_3B2d().unpack(str[start:end])
