...
"""autogenerated by genpy from ros_sensor_msgs/SensorType.msg. Do not edit."""
import sys
...
class SensorType(genpy.Message):
  _md5sum = "3fe390b5ba2bf66b459cdc2b21df74dd"
  _type = "ros_sensor_msgs/SensorType"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """## Sensor Type
...
uint8 type"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SensorType, self).__init__(*args, **kwds)
