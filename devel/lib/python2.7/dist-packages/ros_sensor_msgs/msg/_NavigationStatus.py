...
"""autogenerated by genpy from ros_sensor_msgs/NavigationStatus.msg. Do not edit."""
import sys
...
class NavigationStatus(genpy.Message):
  _md5sum = "f2931775966732172fda0561a2b051ee"
  _type = "ros_sensor_msgs/NavigationStatus"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_H().pack(self.navigation_status))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.navigation_status,) = _get_struct_H().unpack(str[start:end])
      return self
