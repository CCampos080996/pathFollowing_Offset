...
"""autogenerated by genpy from ros_sensor_msgs/AtmosphericCorrectionTagged.msg. Do not edit."""
import sys
...
class AtmosphericCorrectionTagged(genpy.Message):
  _md5sum = "c4cbb8962ede7e719304cc228b702e29"
  _type = "ros_sensor_msgs/AtmosphericCorrectionTagged"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """## Atmospheric correction with header
...
float64 troposphereCorrection  # Troposphere correction [m]"""
  __slots__ = ['header','tags','corrections']
  _slot_types = ['std_msgs/Header','ros_sensor_msgs/Tags','ros_sensor_msgs/AtmosphericCorrection[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AtmosphericCorrectionTagged, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ros_sensor_msgs.msg.AtmosphericCorrection()
        _x = val1
        start = end
        end += 26
