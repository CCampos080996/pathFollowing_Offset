...
"""autogenerated by genpy from ros_sensor_msgs/EnuVelocityTagged.msg. Do not edit."""
import sys
...
class EnuVelocityTagged(genpy.Message):
  _md5sum = "dbc839fae8ba36a3a3721a35d2ea7099"
  _type = "ros_sensor_msgs/EnuVelocityTagged"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """## EnuVelocityTagged
...
float32                  verticalAccuracy    """
  __slots__ = ['header','tags','enuVelocity']
  _slot_types = ['std_msgs/Header','ros_sensor_msgs/Tags','ros_sensor_msgs/EnuVelocity']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EnuVelocityTagged, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3B3d2f().pack(_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.enuVelocity.eastVelocity, _x.enuVelocity.northVelocity, _x.enuVelocity.upVelocity, _x.enuVelocity.horizontalAccuracy, _x.enuVelocity.verticalAccuracy))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.enuVelocity.eastVelocity, _x.enuVelocity.northVelocity, _x.enuVelocity.upVelocity, _x.enuVelocity.horizontalAccuracy, _x.enuVelocity.verticalAccuracy,) = _get_struct_3B3d2f().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_3B3d2f = None
def _get_struct_3B3d2f():
    global _struct_3B3d2f
    if _struct_3B3d2f is None:
        _struct_3B3d2f = struct.Struct("<3B3d2f")
    return _struct_3B3d2f
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
