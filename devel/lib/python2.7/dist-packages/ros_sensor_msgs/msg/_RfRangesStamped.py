...
"""autogenerated by genpy from ros_sensor_msgs/RfRangesStamped.msg. Do not edit."""
import sys
...
class RfRangesStamped(genpy.Message):
  _md5sum = "1875fd89c955438fb4427088e543c91c"
  _type = "ros_sensor_msgs/RfRangesStamped"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(RfRangesStamped, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = ros_sensor_msgs.msg.RfRange()
        _x = val1
        start = end
        end += 48
