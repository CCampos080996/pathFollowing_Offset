...
"""autogenerated by genpy from ros_sensor_msgs/ReceiverType.msg. Do not edit."""
import sys
...
class ReceiverType(genpy.Message):
  _md5sum = "a58e9fc00f5d5355c75be34df1d73a87"
  _type = "ros_sensor_msgs/ReceiverType"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """uint8 RECEIVER_TYPE_UBLOX = 0
...
uint8 type"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ReceiverType, self).__init__(*args, **kwds)
