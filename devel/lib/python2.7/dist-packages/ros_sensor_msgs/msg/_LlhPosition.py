...
"""autogenerated by genpy from ros_sensor_msgs/LlhPosition.msg. Do not edit."""
import sys
...
class LlhPosition(genpy.Message):
  _md5sum = "c6f425fbcae84dae779ac1c441d3712e"
  _type = "ros_sensor_msgs/LlhPosition"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# # LlhPosition
...
uint16                   verticalAccuracy"""
  __slots__ = ['latitude','longitude','altitude','horizontalAccuracy','verticalAccuracy']
  _slot_types = ['float64','float64','float64','uint16','uint16']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(LlhPosition, self).__init__(*args, **kwds)
