...
"""autogenerated by genpy from ros_sensor_msgs/SvStateTagged.msg. Do not edit."""
import sys
...
class SvStateTagged(genpy.Message):
  _md5sum = "bb3a8aaa166c2d3db9dfb5473e2b70df"
  _type = "ros_sensor_msgs/SvStateTagged"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """## Satellite vehicle state with tags and header
...
float64 y
float64 z"""
  __slots__ = ['header','tags','svState']
  _slot_types = ['std_msgs/Header','ros_sensor_msgs/Tags','ros_sensor_msgs/SvState']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SvStateTagged, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.tags is None:
        self.tags = ros_sensor_msgs.msg.Tags()
      if self.svState is None:
        self.svState = ros_sensor_msgs.msg.SvState()
    else:
      self.header = std_msgs.msg.Header()
      self.tags = ros_sensor_msgs.msg.Tags()
      self.svState = ros_sensor_msgs.msg.SvState()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3BH10d().pack(_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.svState.prn, _x.svState.position.x, _x.svState.position.y, _x.svState.position.z, _x.svState.velocity.linear.x, _x.svState.velocity.linear.y, _x.svState.velocity.linear.z, _x.svState.velocity.angular.x, _x.svState.velocity.angular.y, _x.svState.velocity.angular.z, _x.svState.svClockCorrection))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.svState.prn, _x.svState.position.x, _x.svState.position.y, _x.svState.position.z, _x.svState.velocity.linear.x, _x.svState.velocity.linear.y, _x.svState.velocity.linear.z, _x.svState.velocity.angular.x, _x.svState.velocity.angular.y, _x.svState.velocity.angular.z, _x.svState.svClockCorrection,) = _get_struct_3BH10d().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_3BH10d = None
def _get_struct_3BH10d():
    global _struct_3BH10d
    if _struct_3BH10d is None:
        _struct_3BH10d = struct.Struct("<3BH10d")
    return _struct_3BH10d
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
