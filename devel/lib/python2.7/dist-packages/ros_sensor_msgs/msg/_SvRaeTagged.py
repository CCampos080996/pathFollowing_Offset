...
"""autogenerated by genpy from ros_sensor_msgs/SvRaeTagged.msg. Do not edit."""
import sys
...
class SvRaeTagged(genpy.Message):
  _md5sum = "dd606ea987b5b63abad9e30e89ab91d2"
  _type = "ros_sensor_msgs/SvRaeTagged"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# SvRae information with tags and header
...
float64         el             # relateive elevation angle to a satellite vehicle from a point [deg]"""
  __slots__ = ['header','tags','svRae']
  _slot_types = ['std_msgs/Header','ros_sensor_msgs/Tags','ros_sensor_msgs/SvRae']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SvRaeTagged, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.header is None:
        self.header = std_msgs.msg.Header()
      if self.tags is None:
        self.tags = ros_sensor_msgs.msg.Tags()
      if self.svRae is None:
        self.svRae = ros_sensor_msgs.msg.SvRae()
    else:
      self.header = std_msgs.msg.Header()
      self.tags = ros_sensor_msgs.msg.Tags()
      self.svRae = ros_sensor_msgs.msg.SvRae()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3BI3d().pack(_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.svRae.prn, _x.svRae.range, _x.svRae.az, _x.svRae.el))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.tags.source.type, _x.tags.dataValid, _x.tags.assuranceLevel.level, _x.svRae.prn, _x.svRae.range, _x.svRae.az, _x.svRae.el,) = _get_struct_3BI3d().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_3BI3d = None
def _get_struct_3BI3d():
    global _struct_3BI3d
    if _struct_3BI3d is None:
        _struct_3BI3d = struct.Struct("<3BI3d")
    return _struct_3BI3d
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
