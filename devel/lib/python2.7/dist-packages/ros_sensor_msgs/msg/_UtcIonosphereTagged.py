...
"""autogenerated by genpy from ros_sensor_msgs/UtcIonosphereTagged.msg. Do not edit."""
import sys
...
class UtcIonosphereTagged(genpy.Message):
  _md5sum = "f7b92f8465167be7ab2c61e6df237b34"
  _type = "ros_sensor_msgs/UtcIonosphereTagged"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """## Subframe of UTC and Ionospheric Parameters with header
...
"""
  __slots__ = ['header','tags','utc_iono']
  _slot_types = ['std_msgs/Header','ros_sensor_msgs/Tags','ros_sensor_msgs/UtcIonosphere']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UtcIonosphereTagged, self).__init__(*args, **kwds)
